...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/job-code'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: JobCode) {
        return item.id;
    }
    ...
    registerChangeInJobCodes() {
        this.eventSubscriber = this.eventManager.subscribe('jobCodeListModification', (response) => this.loadAll());
    }
